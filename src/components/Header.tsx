...
export default function Header() {
  ...
  const renderThemeToggle = () => {
    ...
    return (
      <button
        onClick={toggleTheme}
        type="button"
        className="flex h-9 w-9 items-center justify-center rounded-full text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 transition-colors cursor-pointer shrink-0"
      ...
      >
        {theme === 'light' ? (
          ...
          <svg className="h-4 w-4 stroke-[2.5] fill-none stroke-current text-zinc-700" viewBox="0 0 24 24">
  ...
  return (
    <div className="sticky top-4 z-50 w-full px-4 sm:px-6 lg:px-8 pointer-events-none">
      <div className="mx-auto max-w-5xl w-full bg-white/95 backdrop-blur-xl border border-zinc-200/90 rounded-full px-5 sm:px-7 py-2.5 shadow-xl shadow-black/5 transition-all duration-300 pointer-events-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-8 sm:gap-10">
          ...
          <Link href="/" className="flex items-center shrink-0">
            <img
              ...
              className="object-contain h-5.5 w-auto block"
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          <button
            ...
            type="button"
            className="flex h-8.5 w-8.5 items-center justify-center rounded-full text-zinc-700 hover:bg-zinc-100 transition-colors"
      ...
      {/* Mobile Menu Panel */}
      <div
        className={`md:hidden transition-all duration-300 ease-in-out mx-auto max-w-5xl mt-2 rounded-3xl bg-white/95 backdrop-blur-xl border border-zinc-200/90 overflow-hidden shadow-2xl pointer-events-auto ${
            ...
            return (
              <Link
                ...
                className={`py-2.5 text-[14px] transition-colors ${
                  isActive ? 'font-bold text-zinc-900' : 'font-medium text-zinc-600 hover:text-zinc-900'
                }`}
              >
                {link.label}
              </Link>
