...
export default function DetailProcessJourney({ data }: { data: SolutionDetailData }) {
  ...
  return (
    <section
      ref={sectionRef}
      id="process-journey"
      className="w-full bg-[#111111] text-white py-20 md:py-28 relative overflow-hidden"
    ...
    >
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* ── RIGHT COLUMN — Spatial Staircase / Ascending Pathway Visual (Matches Approved Image) ── */}
          <div className="lg:col-span-7 relative flex flex-col justify-center">
            
            {/* Spatial Staircase Container */}
            <div className="relative w-full flex flex-col gap-2 py-4">
              {data.processSteps.map((step, idx) => {
                const isActive = idx === activeStepIndex;
                const isPast = idx < activeStepIndex;

                // Indentation to create physical ascending stair step effect matching reference
                ...
                return (
                  <div
                    ...
                    className={`relative rounded-md px-5 py-4 transition-all duration-500 cursor-pointer border ${
                      isActive
                        ? 'bg-[#222222] border-white/30 text-white shadow-xl scale-[1.01] z-20'
                        : isPast
            ...
            {/* Handwritten Annotation top-right — matches approved reference "A clear path to a stronger tomorrow." */}
